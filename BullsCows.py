...
MyNumList = []
for c in MyNum:#turns the number to be guessed into a readavle form to print in the end
...
def PlayTheGame(TriesLeft): #defines the function that starts the game
  while TriesLeft >= 0:
    ...
    print "Number of Bulls:", CheckBulls(Guesslist) #tells number of Bulls
